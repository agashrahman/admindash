...
function Category() {
  ...
  return (
    <div>
       <div className="position-fixed col-lg-12"> <DashNavbar/></div>
    <div className="d-flex">
        <div className="position-fixed"><SideBar/></div>
    <div className="container-fluid-category col-lg-10 ms-5" style={containerStyle}>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 mt-4 d-flex justify-content-end align-items-center pe-3">
              <button className="btn custom-button custom-category" onClick={handleCreateCategory}>CREATE NEW CATEGORY</button>
            </div>
          </div>
        </div>
      </div>
